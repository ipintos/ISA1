...
![Pantalla inicio](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/PantallaInicio.png)
![Funcionalidad agendar](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/PantallaInicioAgendar.png)

- Tabs difíciles de visualizar

![Tabs](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/TabsDificilAcceso.png)

- Botones que no revelan intención.

![Botones](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Botones.png)

- Información muy técnica difícil de entender por la mayoría de los estratos sociales.

![Grafica 1](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/GraficaI.png)
![Grafica 2](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/GraficaII.png)
![Grafica 3](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/GraficaIII.png)

## Criticas de usuarios

- Fallas de conectividad

![Reseña conexión 1](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aConexionI.png)
![Reseña conexión 2](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aConexionII.png)

- Fallas en obtención de código de validación.

![Código validación 1](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aCodigoValidacionI.png)
![Código validación 2](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aCodigoValidacionII.png)

- Fallas en cambio de datos personales

![Cambio de datos 1](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aCambiarDatosI.png)
![Cambio de datos 2](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aCambiarDatosII.png)

- Extranjeros con residencias en Uruguay

![Extranjero](https://github.com/condesahreyes/PruebaMD/blob/master/imagenes/Rese%C3%B1aExtranjero.png)
