...
Dado que al día de hoy existe una competencia considerable en el mercado, la aplicación Coronavirus Uy, la cual ha tenido un fuerte impacto en este último año, posicionado como nuestra competencia directa.

Dado que al día de hoy Coronavirus Uy está bien posicionada en el mercado y la misma está siendo utilizada por un gran porcentaje de la población contamos con un poder de negociación medio de los clientes.

Para poder solventar este problema y poder competir con nuestro rival directo debemos proponer una nueva aplicación que mejore en todos los aspectos a las funcionalidades principales y necesarias que ya están siendo brindadas por nuestro competidor.

A su vez vemos necesarias otras funcionalidades que hoy en día no están siendo ofrecidas por la competencia que le aportarán valor al cliente pudiendo así mejorar el poder de negociación de nuestra población.

### Poder de negociación de los proveedores

**Nivel:** Bajo

Agesic (la Agencia de Gobierno Electrónico y Sociedad de la Información y del Conocimiento) es una unidad ejecutora de la República la cual lidera el desarrollo del gobierno digital lo cual conlleva a ser uno de los fuertes proveedores del mercado dado que el plan de vacunación es realizado por el estado.

Por otro lado, el MSP (Ministerio de Salud Pública) es el encargado de garantizar el derecho a la salud de los habitantes del país, este ministerio conlleva a ser un proveedor clave en sistemas relacionados a la salud.

Estos dos organismos, Agesic y el MSP, son los principales proveedores de este rubro.

La aplicación Coronavirus Uy es operada y gestionada por Agesic y el Ministerio de Salud Pública del Uruguay por lo que conlleva a contar con un poder de negociación con los proveedores muy bajo o nulo.

### Amenaza de nuevos competidores entrantes

**Nivel:** Bajo

La principal barrera de entrada a competidores serán los proveedores del estado (AGESIC, MSP) los cuales serán difíciles de negociar por lo mencionado anteriormente.
Para que un competidor sea capaz de ser una amenaza para nosotros, deberá obtener una gran cantidad de proveedores privados, para evitar esto, deberemos tener una estrategia agresiva la cual nos permita en los primeros meses obtener una gran cantidad de proveedores, así, cualquier posible competidor estará en desventaja.
...
Actualmente tenemos una única competencia, la cual ha logrado posicionarse de forma efectiva en el mercado. La misma cuenta con dos proveedores importantes del mercado.

Nuestro principal objetivo para poder competir es mejorar en todos los aspectos las funcionalidades que ya ofrece nuestro rival y brindar nuevos servicios que no están siendo cubiertos por el mismo.

A su vez de negociar con todos los proveedores privados relacionados al Covid-19 para poder respaldar y aumentar el número de usuarios de nuestra aplicación.
...
![Iteración3-backlog.png](https://github.com/ipintos/ISA1/blob/feature/main/imagenes/Iteración3-backlog.png)
...
![iteracion3-burndown.png](https://github.com/ipintos/ISA1/blob/feature/main/imagenes/iteracion3-burndown.png)
